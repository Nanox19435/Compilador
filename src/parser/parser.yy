...
lista_id:
    ...
    ;
decl_proto:
    PROTO tipo ID LPAR lista_tipos RPAR { for(string tipo : $3) driver.addSym(id, $2, "proto"); } 
    ;
lista_tipos:
    tipos {}
    | /*empty*/ {}
...
tipos:
    ...
    ;
decl_func:
    FUNC tipo ID LPAR lista_param RPAR bloque {for(string param : $3) driver.addSym(id, $2, "param"); } 
    ;
tipo:
...
tipo_estructura:
    ...
    ;
decl_campo:
    tipo lista_id PYC decl_campo {for(string id : $3) driver.addSym(id, $2, "tipo");}
    | /*empty*/ {}
    ;
lista_param:
    decl_params {}
